  ...
  function buildHTML(activeKey) {
    ...
    return `
      ...
      <div class="vt-slide-panel" id="vtAppsPanel">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:0 14px 18px">
          <a href="${resolveHref('app/applications.html')}" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;padding:18px 12px;border-radius:16px;text-decoration:none;border:1px solid rgba(56,189,248,0.35);background:rgba(56,189,248,0.12);cursor:pointer;-webkit-tap-highlight-color:transparent">
            <div style="width:72px;height:72px;border-radius:16px;display:flex;align-items:center;justify-content:center;background:#93c5fd;box-shadow:0 2px 8px rgba(0,0,0,0.12)"><img width="44" height="44" src="https://img.icons8.com/?size=100&id=aofWp8x2uWHs&format=png&color=000000" alt="Ứng dụng" style="object-fit:contain"/></div>
          ...
          <a href="${resolveHref('games.html')}" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;padding:18px 12px;border-radius:16px;text-decoration:none;border:1px solid rgba(167,139,250,0.35);background:rgba(167,139,250,0.12);cursor:pointer;-webkit-tap-highlight-color:transparent">
            <div style="width:72px;height:72px;border-radius:16px;display:flex;align-items:center;justify-content:center;background:#c4b5fd;box-shadow:0 2px 8px rgba(0,0,0,0.12)"><img width="44" height="44" src="https://img.icons8.com/?size=100&id=cdTzm4ndoVu4&format=png&color=000000" alt="Game" style="object-fit:contain"/></div>
